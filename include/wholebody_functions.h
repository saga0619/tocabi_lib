...
namespace WBC
{
    ...
    VectorQd TaskControlHQP(RobotData &rd_, const MatrixXd &J_task, const MatrixXd &Jkt_, const VectorXd &fstar_, const VectorQd &torque_prev, const MatrixXd &prev_task_null_);
